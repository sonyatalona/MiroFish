...
const initObserver = () => {
  ...
  observer = new IntersectionObserver(
    ...
    },
    {
      ...
      // Adjust rootMargin, viewport bottom shrinks upward, requires more scroll to trigger expand
...
.grid-pattern {
  ...
  /* Position from top-left, height changes only extend at bottom without affecting existing grid */
