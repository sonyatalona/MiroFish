 ...
 * When the user navigates back from Step 3 to Step 2, assume they want to exit the simulation.
 */
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        // If graceful shutdown threw an error, try force stop
        await forceStopSimulation()
      }
    } else {
...
onMounted(async () => {
  ...
  // Check and stop any running simulation (when user navigates back from Step 3)
