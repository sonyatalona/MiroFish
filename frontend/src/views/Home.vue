            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Reality Seeds extraction & individual/collective memory injection & GraphRAG construction</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relationship extraction & persona generation & environment Agent parameter injection</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction scenario in natural language (e.g., What public opinion trends would emerge if a university reverses a disciplinary decision?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Add files (filter by valid extensions)
...
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate to Process page (using special ID to indicate a new project)
    router.push({
      name: 'Process',
