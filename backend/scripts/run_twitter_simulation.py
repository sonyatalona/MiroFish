...
This script reads parameters from a configuration file to execute simulation, achieving full automation.
...
async def main():
    ...
    # Initialize logging configuration (using fixed filenames, cleaning up old logs)
...
def setup_signal_handlers():
    """
    Set up signal handlers to ensure proper exit upon receiving SIGTERM/SIGINT.
    Gives the program a chance to cleanly release resources (close database, environment, etc.)
    """
