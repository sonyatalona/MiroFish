...
API Step 2: Build Standalone Graph using Zep API
"""
...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        Args:
            text: Input text
            ontology: Ontology definition (from API step 1 output)
    ...
    def add_text_batches(
        ...
        """Add text to graph in batches, returning all episode UUIDs"""
        episode_uuids = []
        total_chunks = len(chunks)
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing nodes and edges with timestamps, attributes, and other detailed data
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
