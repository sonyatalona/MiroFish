...
API Step 1: Analyze text content and generate entity and relationship type definitions for social simulation
"""
...
**Can be**:
- Specific individuals (public figures, parties involved, opinion leaders, academics, ordinary people)
    ...
    "entity_types": [
        {
            ...
            "description": "Brief description (English, under 100 characters)",
            "attributes": [
                {
...
A. **Fallback types (must be included, placed as the last 2 in the list)**:
   - `Person`: Fallback type for any individual person. When a person doesn't fit other more specific person types, assign to this type.
   - `Organization`: Fallback type for any organizational entity. When an organization doesn't fit other more specific organization types, assign to this type.
...
- Ensure relationship source_targets cover the entity types you've defined
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Final safeguard to ensure limits aren't exceeded (defensive programming)
