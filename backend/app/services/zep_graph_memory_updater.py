...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return "agent_name: activity_description" format without simulation prefix
...
class ZepGraphMemoryUpdater:
    ...
    after accumulating BATCH_SIZE activities.
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context information (e.g., post content, user names).
    ...
    def _flush_remaining(self):
        ...
        # First process remaining activities in the queue, adding to buffers
        ...
        # Then send remaining activities from each platform buffer (even if below BATCH_SIZE)
        with self._buffer_lock:
