...
class OasisProfileGenerator:
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        Zep does not have a built-in hybrid search API, so edges and nodes need to be searched separately and results merged.
        ...
        try:
            ...
            logger.info(f"Zep hybrid search completed: {entity_name}, fetched {len(results['facts'])} facts, {len(results['node_summaries'])} related nodes")
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        ...
        # 4. Use Zep hybrid search for richer info
    ...
    def _generate_profile_with_llm(
        ...
        logger.warning(f"LLM profile generation failed ({max_attempts} attempts): {last_error}, falling back to rule-based generation")
    ...
    def _build_individual_persona_prompt(
        ...
        # NOTE: This is an LLM prompt template - Chinese content is intentional for the AI model
...
- 机构账号发言要符合其身份定位"""
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=parallel_count) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_entity):
                ...
                try:
                    ...
                    logger.error(f"Exception occurred processing entity {entity.name}: {str(e)}")
                    with lock:
                        completed_count[0] += 1
    ...
    def _normalize_gender(self, gender: Optional[str]) -> str:
        ...
        gender_map = {
            "男": "male",        # Chinese for male
            "女": "female",      # Chinese for female
            "机构": "other",     # Chinese for institution
            "其他": "other",     # Chinese for other
